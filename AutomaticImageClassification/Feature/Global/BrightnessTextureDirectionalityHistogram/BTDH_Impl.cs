...
namespace AutomaticImageClassification.Feature.Global.BrightnessTextureDirectionalityHistogram
{
    ...
    /**
     * Implementation of the Tamura features done by  Marko Keuschnig & Christian Penz @author Mathias Lux, mathias@juggle.at
     * 
     * BTDH is part of the Compact Composide Descriptors http://www.img-rummager.com * 
     * 
     * CONTENT BASED MEDICAL IMAGE INDEXING AND RETRIEVAL USING A NEW COMPACT COMPOSITE DESCRIPTOR
     ...
     * ybout@ee.duth.gr
     * 
     * @ savvas chatzichristofis --> img(Rummager) 2008
     */


    public class BTDH_Impl
    {
        ...
        public BTDH_Impl(int TextureAreas, int BrightnessAreas, bool SpatialInformation)
        {
