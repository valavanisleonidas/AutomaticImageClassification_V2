...
namespace AutomaticImageClassification.Feature.Global.ColorEdgeDirectivityDescriptor
{
    public class CEDD_Impl
    {
        ...
        public CEDD_Impl(double Th0, double Th1, double Th2, double Th3, bool CompactDescriptor)
        {
            this.T0 = Th0;
            this.T1 = Th1;
            this.T2 = Th2;
        ...
        public double[] Apply(Bitmap srcImg)
        {
            ...
            for (int y = 0; y < height; y++)
            {
                ...
                {
                    Color cl = srcImg.GetPixel(x, y);

                    int[] color = ColorConversion.ConvertFromRGB(ColorSpace.RGB, cl.R, cl.G, cl.B);
                    colors.Add(color);
