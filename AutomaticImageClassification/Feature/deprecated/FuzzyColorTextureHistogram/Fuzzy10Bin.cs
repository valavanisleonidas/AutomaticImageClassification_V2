...
namespace AutomaticImageClassification.Feature.Global.FuzzyColorTextureHistogram

{
    class Fuzzy10Bin
    {
        ...
        protected static double[] HueMembershipValues = new double[32] { 0,0,5, 10,
               5,10,35,50,
               35,50,70, 85, 
               70,85,150, 165, 
               150,165,195, 205,
        ...
        protected static double[] SaturationMembershipValues = new double[8]      { 0,0,10, 75,
              10,75,255,255 };

        protected static double[] ValueMembershipValues = new double[12] { 0,0,10, 75, 
               10,75,180, 220,
               180,220,255,255 };
        ...
        public static int[,] Fuzzy10BinRulesDefinition = new int[48, 4]{
                          {0,0,0,2},                          
                          {0,1,0,2},
                          {0,0,2,0},
                          {0,0,1,1},
