...
if (typeof jQuery.fn.draggable === "undefined") {
 ...
 function gradX (uniqueId, element, _options) {
        ...
        var gradx = {
            ...
            direction: "0deg", //direction of gradient or position of centre in case of radial gradients
            ...
            //apply styles on fly
            apply_style: function (ele, value, callChange) {
                callChange = callChange != null ? callChange : true;
                ...
                gradx.gx("#gradx_code_" + uniqueId).html(css);
            ...
            load_info: function (ele) {
                ...
                if (this.slider_ids.indexOf(ele.id) > -1) { //javascript does not has # in its id
                    ...
                    if (parseInt(left) > -1 && parseInt(left) < 301) {
                        gradx.gx("#gradx_slider_info_" + uniqueId) //info element cached before
                                .css("left", left)
                                .show();
            ...
            add_slider: function (sliders) {
                ...
                if (sliders.length === 0) {
                    ...
                    gradx.apply_style(gradx.panel, gradx.get_style_value(), false);
                }
                ...
                for (k in gradx.obj) {
                    if (typeof gradx.obj[k].position === "undefined")
                        break;
                    if (gradx.obj[k].position == "NaN") {
                        position = 0;
                    }

                    var delta = 0; //range: 26px tp 426px
                    position = parseInt((gradx.obj[k].position * this.container_width) / 100) + delta + "px";

                    id = "gradx_slider_" + uniqueId + "_" + (this.slider_index); //create an id for this slider
                    this.sliders.push(
                            [
                                gradx.obj[k].color,
                                gradx.obj[k].position
                            ]
                            );
                    ...
                    gradx.gx(".gradx_start_sliders").append(slider);



                    gradx.gx('#' + id).css("backgroundColor", gradx.obj[k].color).css("left", position);
                    this.slider_index++;
                }
            ...
            set_colorpicker: function (clr) {
                gradx.cp.spectrum({
                    move: function (color) {
                        ...
                        if (gradx.current_slider_id != false && gradx.gx("#gradx_slider_info_" + uniqueId).is(':visible')) {
                    ...
                    change: function () {
                        ...
                        gradx.gx("#gradx_slider_info" + uniqueId).hide();
                    },
                    flat: true,
                    showAlpha: true,
                    color: clr,
            ...
            generate_radial_options: function () {
                ...
                gradx.gx('.gradx_gradient_subtype').show();
                gradx.gx('#gradx_gradient_subtype_' + uniqueId).html(gradx.generate_options(options));
                // gradx.type = type;
                gradx.gx("#gradx_gradient_type_" + uniqueId).val(gradx.type);
                options = ["vertical-center disabled", "center selected", "top", "bottom"];
                gradx.gx('#gradx_gradient_subtype2_' + uniqueId).html(gradx.generate_options(options)).show();
                gradx.gx("#gradientAngle_" + uniqueId).addClass("hidden");
                gradx.gx("#degreesControl_" + uniqueId).addClass("hidden");
            ...
            generate_linear_options: function () {
                ...
                gradx.gx('#gradx_gradient_subtype_' + uniqueId).addClass("hidden");

                gradx.gx('#gradx_gradient_subtype2_' + uniqueId).addClass("hidden");
                gradx.type = "linear";
                gradx.direction = gradx.gx('#gradx_gradient_subtype_' + uniqueId).val();
                gradx.gx("#gradientAngle_" + uniqueId).removeClass("hidden");
                gradx.gx("#degreesControl_" + uniqueId).removeClass("hidden");
            ...
            load_gradx: function (uniqueId, element, sliders) {
                this.me = element;
                this.element = element;
                // this.id = id.replace("#", "");
                this.uniqueId = uniqueId;
                gradx.id = element.attr('id');
                this.current_slider_id = false;
                var html = "<div class='gradx'>\n\
                        <div class='gradxcontrolpanel'>\n\
                        <div id='gradx_add_slider_"+ uniqueId + "' class='gradx_add_slider gradx_btn'><i class='fa fa-plus-circle'></i>Add</div>\n\
                        <div id='gradx_clear_sliders_" + uniqueId + "' class='gradx_clear_sliders gradx_btn'><i class='fa fa-times'></i>Clear</div></div>\n\
                        <div class='gradx_slectboxes'>\n\
                        <select id='gradx_gradient_type_" + uniqueId + "' class='gradx_gradient_type'>\n\
                            <option value='linear'>Linear</option>\n\
                            <option value='circle'>Radial - Circle</option>\n\
                            <option value='ellipse'>Radial - Ellipse</option>\n\
                        </select>\n\
                        <select id='gradx_gradient_subtype_" + uniqueId + "' class='gradx_gradient_type'>\n\
                            <option id='gradx_gradient_subtype_desc_" + uniqueId + "' value='gradient-direction' disabled>gradient direction</option>\n\
                            <option value='left' selected>Left</option>\n\
                            <option value='right'>Right</option>\n\
                            <option value='top'>Top</option>\n\
                            <option value='bottom'>Bottom</option>\n\
                        </select>\n\
                        <select id='gradx_gradient_subtype2_" + uniqueId + "' class='gradx_gradient_type'>\n\
                        </select>\n\
                        <span id='gradientAngle_" + uniqueId + "'><span class='angle-container'><span id='anglepicker'></span></span>\n\
                        </div>\n\
                        <div id='degreesControl_" + uniqueId + "' class='input-control text-input unit-box'><input type='text' class='input'><span class='unit'></span>\n\
                        <div class='right-control ticks'><a href='#' class='tick sprite-mid up'><i></i></a><span class='sep'></span><a href='#' class='tick sprite-mid down'><i></i></a></div></div>\n\
                        <div class='gradx_container' id='gradx_" + uniqueId + "_" + gradx.id + "'>\n\
                            <div id='gradx_stop_sliders_" + uniqueId + "_" + gradx.id + "'></div>\n\
                            <div class='gradx_panel' id='gradx_panel_" + uniqueId + "_" + gradx.id + "'></div>\n\
                            <div class='gradx_start_sliders'  id='gradx_start_sliders_" + uniqueId + "_" + gradx.id + "'>\n\
                                <div class='cp-default' id='gradx_slider_info_" + uniqueId + "'>\n\
                                    <div id='gradx_slider_controls_" + uniqueId + "'>\n\
                                        <div id='gradx_delete_slider_" + uniqueId + "' class='gradx_btn'><a class='fa fa-times'></a>delete</div>\n\
                                    </div>\n\
                                    <div id='gradx_slider_content_" + uniqueId + "'></div>\n\
                                </div> \n\
                            </div>\n\
                        </div>\n\
                        <div style='width:40%;    display: -webkit-inline-box;'><div id='gradx_cancel_" + uniqueId + "' class='gradx_cancel gradx_btn' style='width:50%'><i class='' ></i>Cancel</div>\n\
                        <div id='gradx_ok_" + uniqueId + "' class='gradx_ok gradx_btn' style='width:50%'><i class=''></i>OK</div></div>\n\
                        <div id='gradx_show_code_" + uniqueId + "' class='gradx_show_code gradx_btn'><i class='icon icon-file-css'></i><span>show the code</span></div>\n\
                        <div id='gradx_show_presets_" + uniqueId + "' style='display:none' class='gradx_show_presets gradx_btn'><i class='icon icon-preset'></i><span>show presets</span></div>\n\
                        <textarea class='gradx_code' id='gradx_code_" + uniqueId + "'></textarea>\n\
                    </div>";
                ...
                this.container = gradx.gx(".gradx_container");
                this.panel = gradx.gx(".gradx_panel");
                ...
                gradx.add_event(document, 'click', function () {
                    if (!gradx.slider_hovered[gradx.id]) {
                        gradx.gx("#gradx_slider_info_" + uniqueId + "").hide();
                        return false;
                    }
                });
                ...
                gradx.gx("#gradx_ok_" + uniqueId).click(function () {

                    gradx.gx().addClass("hidden");
                    $(".button", $(".backgroundField")).removeClass("active");

                });

                gradx.gx("#gradx_add_slider_" + uniqueId).click(function () {

                    if (gradx.slider_ids.length >= 30) {
                        gradx.gx("#gradx_add_slider_" + uniqueId + "").addClass("disabled");
                        return;
                    } else {
                        gradx.gx("#gradx_add_slider_" + uniqueId + "").removeClass("disabled");
                    }
                ...
                gradx.gx("#gradx_clear_sliders_" + uniqueId + "").click(function () {
                    gradx.gx(".gradx_gradient_type").removeClass("hidden gradx_hide");
                    //   gradx.type = "linear";
                    gradx.delete_all_sliders();
                    gradx.gx("#gradx_gradient_type_" + uniqueId).val('linear');
                ...
                //cache the element
                gradx.cp = gradx.gx("#gradx_slider_content_" + uniqueId + "");

                //call the colorpicker plugin
                gradx.set_colorpicker("blue");

                gradx.gx("#gradx_delete_slider_" + uniqueId + "").click(function () {
                ...
                gradx.gx("#gradx_code_" + uniqueId + "").focus(function () {
                ...
                gradx.gx("#gradx_gradient_type_" + uniqueId).change(function () {
                ...
                if (this.type !== "linear") {
                    gradx.gx("#gradx_gradient_type_" + uniqueId + "").val(this.type);
                    gradx.generate_radial_options();
                    ...
                    if (this.direction !== 'left') {
                        ...
                        gradx.gx("#gradx_gradient_subtype_" + uniqueId + "").val(h);
                        gradx.gx("#gradx_gradient_subtype2_" + uniqueId + "").val(v);
                    } else {
                        var h = gradx.gx("#gradx_gradient_subtype_" + uniqueId + "").val();
                        var v = gradx.gx("#gradx_gradient_subtype2_" + uniqueId + "").val();
                    }
                    ...
                    gradx.apply_style(gradx.panel, gradx.get_style_value(), true);//(where,style)
                }

                gradx.gx("#gradx_gradient_subtype_" + uniqueId + "").change(function () {
                ...
                gradx.gx("#gradx_gradient_subtype2_" + uniqueId + "").change(function () {
                ...
                gradx.gx("#gradx_show_code_" + uniqueId + "").click(function () {
                    ...
                    if (gradx.code_shown) {
                        ...
                        gradx.gx("#gradx_code_" + uniqueId + "").hide();
                    }
                    else {
                        //show it

                        //  gradx.gx('#gradx_show_code span').text("hide the code");
                        gradx.gx("#gradx_code_" + uniqueId + "").show();
                ...
                if (gradx.code_shown) {
                    ...
                    gradx.gx("#gradx_show_code span_" + uniqueId + "").text("hide the code");
                    gradx.gx("#gradx_code_" + uniqueId + "").show();

                }

                gradx.add_event(document.getElementById('gradx_slider_info_' + uniqueId), 'mouseout', function () {
                    gradx.slider_hovered[id] = false;
                });
                gradx.add_event(document.getElementById('gradx_slider_info_' + uniqueId), 'mouseover', function () {
            ...
            delete_slider(sliderId) {
                ...
                gradx.gx(sliderId).remove();
                var id = sliderId.replace("#", "");
                gradx.gx("#gradx_add_slider_" + uniqueId + "").removeClass("disabled");
                //remove all references from array for current deleted slider
                ...
                gradx.sliderId = false; //no slider is selected
            },
            init_all_sliders() {
                ...
                gradx.gx("#gradx_add_slider_" + uniqueId + "").removeClass("disabled");
                gradx.slider_ids = [];
                gradx.gx(".gradx_slider", this.element).remove();
                //apply modified style after removing the slider
                //  gradx.update_style_array();
                // gradx.apply_style(gradx.panel, gradx.get_style_value());
            ...
            delete_all_sliders() {
                ...
                //remove all references from array for current deleted slider
                //  $("#gradx_add_slider").removeClass("disabled");
                gradx.slider_ids = [];
                gradx.gx(".gradx_slider").remove();
                gradx.add_slider([]);
                //apply modified style after removing the slider
                //  gradx.update_style_array();
                // gradx.apply_style(gradx.panel, gradx.get_style_value());
        ...
        gradx.gix.extend(options, _options);
        ...
        gradx.load_gradx(uniqueId, element, gradx.sliders);
